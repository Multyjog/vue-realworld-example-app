  ...
  ["chunk-2d217357"],
  {
    c66d: function(t, e, s) {
                ...
                s(
                  ...
                  [
                    s("div", { staticClass: "articles-toggle" }, [
                      s("ul", { staticClass: "nav nav-pills outline-active" }, [
                        s(
                          "li",
      ...
      var u = {
          name: "RwvProfile",
          mounted: function() {
            this.$store.dispatch(o["o"], this.$route.params);
          },
          computed: l(
            {},
            Object(a["b"])(["currentUser", "profile", "isAuthenticated"])
          ),
          methods: {
            ...
            follow: function() {
              this.isAuthenticated &&
                this.$store.dispatch(o["p"], this.$route.params);
            },
            unfollow: function() {
              this.$store.dispatch(o["q"], this.$route.params);
            }
          },
          watch: {
            $route: function(t) {
              this.$store.dispatch(o["o"], t.params);
            }
          }
        },
        f = u,
        p = s("2877"),
        v = Object(p["a"])(f, i, n, !1, null, null, null);
      e["default"] = v.exports;
    }
  }
]);
//# sourceMappingURL=chunk-2d217357.6789dbda.js.map
